    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[480px] px-4 py-6 pb-10 space-y-4">
        ...
        <button
          ...
          className="w-full h-11 rounded-xl border border-red-500/25 text-red-400 text-[14px] font-medium flex items-center justify-center gap-2 hover:bg-red-400/8 transition-colors"
        >
