        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex-1 flex flex-col items-center justify-center gap-1 py-4 min-h-[64px] relative transition-colors"
            ...
            >
              ...
              <span className={`text-[22px] leading-none ${isActive ? "text-[#2196F3]" : "text-[#888888]"}`}>{tab.icon}</span>
            </button>
          );
        })}
      </div>
